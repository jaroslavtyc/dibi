...
class DibiColumnInfo extends DibiObject {
	...
	public static function detectType($type) {
		static $patterns = array('^_' => pribi::TEXT, // PostgreSQL arrays
			'BYTEA|BLOB|BIN' => pribi::BINARY, 'TEXT|CHAR|POINT|INTERVAL' => pribi::TEXT, 'YEAR|BYTE|COUNTER|SERIAL|INT|LONG|SHORT' => pribi::INTEGER, 'CURRENCY|REAL|MONEY|FLOAT|DOUBLE|DECIMAL|NUMERIC|NUMBER' => pribi::FLOAT, '^TIME$' => pribi::TIME, 'TIME' => pribi::DATETIME, // DATETIME, TIMESTAMP
			'DATE' => pribi::DATE, 'BOOL' => pribi::BOOL,);
